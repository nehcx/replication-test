...
Code source:
https://github.com/a1da4/sppmi-svd/blob/d1648f59a650caafec2f3de7ac30c9aed2a87e75/main.py
"""
import argparse
import logging
import os
...
def main(args):
    ...
    if args.cooccur_pretrained is not None:
        ...
        c_name = "model/{}_C_w-{}".format(args.name, args.window_size)
    ...
    if args.sppmi_pretrained is not None:
        ...
        m_name = "model/{}_SPPMI_w-{}_s-{}".format(args.name, args.window_size,
                                                   args.shift)
    ...
    wv_name = "model/{}_WV_d-{}_w-{}_s-{}".format(args.name, args.dim,
...
def cli_main():
    ...
    parser.add_argument("--cooccur_pretrained",
                        help="pre-trained cooccur matrix (file)")
    parser.add_argument("--sppmi_pretrained",
                        help="pre-trained sppmi matrix (file)")
    parser.add_argument(
        "-t",
        "--threshold",
        type=int,
